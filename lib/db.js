...
// market_current_price/market_no_price (via a LEFT JOIN — a trade must
// survive even if its market was since deleted from the local catalog)
// mirror server/src/db.js's listTrades, powering the My Trades grid's live
// "Current price"/"Position value"/"P&L" columns.
