// Per-trade profit & loss: a share bought at `entryPrice` pays out $1 on a
// win, so staking `stake` buys stake/entryPrice shares — payout =
// stake/entryPrice if the trade's side won, else 0; profit = payout - stake.
// Mirrors server/src/pnl.js.
